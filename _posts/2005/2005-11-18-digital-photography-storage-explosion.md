...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image002.gif)
Figure 1
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image004.gif)
Figure 2
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image006.gif)
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image008.gif)
Figure 4
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image010.gif)
Figure 5
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image012.gif)
Figure 6
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image014.gif)
Figure 7

![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image016.gif)
Figure 8
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image020.gif)
...
![](/assets/posts/{{ page.date | date: "%Y" }}/DigitalPhotographyStorageExplosion-image022.gif)
Figure 10
