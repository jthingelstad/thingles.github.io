...
![thermometer-messed.png](/assets/posts/{{ page.date | date: "%Y" }}/thermometer-messed.png)
...
![thermometer-calibrated.png](/assets/posts/{{ page.date | date: "%Y" }}/thermometer-calibrated.png)
