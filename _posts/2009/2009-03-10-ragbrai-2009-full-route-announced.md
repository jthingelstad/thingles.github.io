...
[![RAGBRAI-2009-Route.png](/assets/posts/{{ page.date | date: "%Y" }}/ragbrai-2009-route.png)](http://data.desmoinesregister.com/ragbrai/2009/route.php)
...
![RAGBRAI-2009-Daily-Mileage-Climbing-Graph.png](/assets/posts/{{ page.date | date: "%Y" }}/ragbrai-2009-daily-mileage-climbing-graph.png)
...
![RAGBRAI-2009-Feet-per-Mile-Graph.png](/assets/posts/{{ page.date | date: "%Y" }}/ragbrai-2009-feet-per-mile-graph.png)
