...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-thingelstad-com.png %})

<!-- more -->Tammy also participated, blacking out Smaller Than A Redwood.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-smallerthanaredwood-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-mazie-me.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-zackstronaut-com.png %})

His template got picked up by a lot of sites, including [Greenpeace](http://www.greenpeace.org/usa/en/).

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-greenpeace-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-en-wikipedia-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-semantic-mediawiki-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-wordpress-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-wordpress-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-eff-org.png %})

I'm also a supporter of [Creative Commons](http://creativecommons.org/) and they put a black banner on top of their site.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-creativecommons-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-arstechnica-com.png %})

[O'Reilly](http://radar.oreilly.com/) did a very nice job with it's blackout and a strong message an simple design.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-oreilly-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-wired-com.png %})

One of the best web comics did an awesome blackout. This is what [xkcd](http://xkcd.com/) did.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-xkcd-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-theoatmeal-com.png %})

[I Can Has Cheezburger](http://icanhascheezburger.com/) had a nicely done call to action.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-icanhascheezburger-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-google-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-flickr-com.png %})

[Mozilla](http://www.mozilla.org/), the organization behind the open source Firefox web browser, participated in the blackout.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-mozilla-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-reddit-com.png %})

[Criagslist](http://craigslist.org/) participated in the most boring HTML display possible, totally fitting Craigslist.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-craigslist-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-boingboing-net.png %})

[Minecraft](http://www.minecraft.net/), a game played by 4.7 million people, went dark for the day.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-minecraft-net.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-facebook-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-pinboard-in.png %})

I was happy to see my congressman [Keith Ellison](http://www.keithellison.org/) participating in the blackout.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-keithellison-org.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-scripting-com.png %})

[Archive.org](http://www.archive.org/) went dark as well.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-archive-org.png %})

## Going White

[TheDailyWTF](http://thedailywtf.com/) decided to be different and go white.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-thedailywtf-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-fark-com.png %})

[ZanHabits](http://zenhabits.net/) also went white, in a very zen way.

![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-zenhabits-net.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-bing-com.png %})
...
![]({{ site.url }}{% link /assets/posts/2012/sopa-scrapbook/sopa-screenshot-yahoo-com.png %})
