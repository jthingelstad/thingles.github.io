...
![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-drives.jpg) ![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-card.jpg)
...
![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-case1.jpg) ![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-case2.jpg) ![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-case3.jpg)
...
![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-cpu1.jpg) ![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-cpu2.jpg)
...
![](/assets/posts/{{ page.date | date: "%Y" }}/r_tb-complete.jpg)
